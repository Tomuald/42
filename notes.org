...
Classes can also be nested within one another:
...
One can also define exception classes within a nested class. You can access them with: ~<CLASS_NAME>::<EXCEPTION_NAME>~.
