...
#+NAME: inheritance-declare
#+BEGIN_SRC C++
#+END_SRC

#+NAME: inheritance-define
#+BEGIN_SRC C++ :results output
#include <string>
...
the type of encapsulation. In the example above, it is ~public~, but
you'll find two others:
...
** TODO Stuff to learn
1) constructors and destructors for parent / children
2) initializing classes with inheritance
#+RESULTS: inheritance-basics
